<?php
// Text
$_['text_title']				= 'Klarna Invoice';//Klarna Invoice - Pay within 14 days
$_['text_terms_fee']			= '<span id="klarna_invoice_toc"></span> (+%s)<script type="text/javascript">var terms = new Klarna.Terms.Invoice({el: \'klarna_invoice_toc\', eid: \'%s\', country: \'%s\', charge: %s});</script>';
$_['text_terms_no_fee']			= '<span id="klarna_invoice_toc"></span><script type="text/javascript">var terms = new Klarna.Terms.Invoice({el: \'klarna_invoice_toc\', eid: \'%s\', country: \'%s\'});</script>';
$_['text_additional']			= 'Klarna requires some additional information before they can proccess your order.';//Klarna Invoice requires some additional information before they can proccess your order.
$_['text_male']					= 'Male';//Male
$_['text_female']				= 'Female';//Female
$_['text_year']					= 'Year';
$_['text_month']				= 'Month';
$_['text_day']					= 'Day';
...
// Entry
$_['entry_gender']				= 'Gender:';//Gender
$_['entry_pno']					= 'PNO / BIRTH DATA:<span class="help">(07071960)</span>';//Personal Number
$_['entry_dob']					= 'Date of Birth';
$_['entry_phone_no']			= 'Phone number';
$_['entry_street']				= 'Street';
$_['entry_house_no']			= 'House No.:';//House No.
$_['entry_house_ext']			= 'House Ext.:';//House Ext.
