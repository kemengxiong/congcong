<?php
// Heading
$_['heading_title']                          = 'Royal Mail';//Royal Mail

// Text
$_['text_shipping']                          = '配送管理';//Shipping
$_['text_success']                           = '成功: Royal Mail 运费更新完成!';//Success: You have modified Royal Mail shipping!
...
// Tab
$_['tab_1st_class_standard']                 = 'First Class Standard Post';//First Class Standard Post
$_['tab_1st_class_recorded']                 = 'First Class Recorded Post';//First Class Recorded Post
$_['tab_2nd_class_standard']                 = 'Second Class Standard Post';//Second Class Standard Post
$_['tab_2nd_class_recorded']                 = 'Second Class Recorded Post';//Second Class Recorded Post
$_['tab_special_delivery_500']               = 'Special Delivery Next Day (&pound;500)';//Special Delivery Next Day (&pound;500)
$_['tab_special_delivery_1000']              = 'Special Delivery Next Day (&pound;1000)';//Special Delivery Next Day (&pound;1000)
$_['tab_special_delivery_2500']              = 'Special Delivery Next Day (&pound;2500)';//Special Delivery Next Day (&pound;2500)
$_['tab_standard_parcels']                   = 'Standard Parcels';//Standard Parcels
$_['tab_airmail']                            = 'Airmail';//Airmail
$_['tab_international_signed']               = 'International Signed';//International Signed
$_['tab_airsure']                            = 'Airsure';//Airsure
$_['tab_surface']                            = 'Surface';//Surface

// Error
$_['error_permission']                       = '警告: 您没有变更Royal Mail运费设定的权限!';//Warning: You do not have permission to modify Royal Mail shipping!