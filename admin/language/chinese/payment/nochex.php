...
$_['entry_account']					= '帐户类型：';//Account Type
$_['entry_merchant']				= '商家ID：';//Merchant ID
$_['entry_template']				= '通过模板：';//Pass Template
$_['entry_test']					= '测试：';//Test
...
// Error
$_['error_permission']				= '警告：您没有权限修改NOCHEX付款！';//Warning: You do not have permission to modify payment NOCHEX!
$_['error_email']					= '邮箱必填！';//E-Mail Required!
$_['error_merchant']				= '商家ID必填！';//Merchant ID Required!