...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
	<!---更改了图片属性--->
    <a href="<?php echo $home; ?>" class="navbar-brand"><img style="height:23px;width:123px" src="view/image/qq.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
