...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
	<!---更改了图片属性--->
    <a href="<?php echo $home; ?>" class="navbar-brand"><img style="height:23px;width:123px" src="view/image/logo.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="#" target="_blank"><?php echo $text_homepage; ?></a></li>
        <li><a href="#" target="_blank"><?php echo $text_documentation; ?></a></li>
        <li><a href="#" target="_blank"><?php echo $text_support; ?></a></li>
      </ul>
    </li>
