...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2015 at 11:58 PM
...
--
-- Table structure for table `cc_administrators`
--

CREATE TABLE IF NOT EXISTS `cc_administrators` (
...
--
-- Dumping data for table `cc_administrators`
--

INSERT INTO `cc_administrators` (`id`, `user_name`, `password`, `grade`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1),
(2, 'admin1', 'e00cf25ad42683b3df678c61f42c6bda', 1),
(3, 'admin2', 'c84258e9c39059a89ab77d846ddab909', 2),
(4, 'admin3', '32cacb2f994f6b42183a1300d9a3e8d6', 3);

-- --------------------------------------------------------

--
-- Table structure for table `cc_affiliate`
--

CREATE TABLE IF NOT EXISTS `cc_affiliate` (
...
--
-- Table structure for table `cc_affiliate_activity`
--

CREATE TABLE IF NOT EXISTS `cc_affiliate_activity` (
...
--
-- Table structure for table `cc_affiliate_login`
--

CREATE TABLE IF NOT EXISTS `cc_affiliate_login` (
...
--
-- Table structure for table `cc_affiliate_transaction`
--

CREATE TABLE IF NOT EXISTS `cc_affiliate_transaction` (
...
--
-- Table structure for table `cc_api`
--

CREATE TABLE IF NOT EXISTS `cc_api` (
...
--
-- Dumping data for table `cc_api`
--

INSERT INTO `cc_api` (`api_id`, `username`, `firstname`, `lastname`, `password`, `status`, `date_added`, `date_modified`) VALUES
(1, 'LUBdlDMV5fed8nglH5W5LUmKhVXh93Pw4eSFHFIM9I1TVnDKgBz8YSvcR46yCz8x', '', '', '', 1, '2015-01-16 18:59:53', '2015-01-16 18:59:53');

-- --------------------------------------------------------

--
-- Table structure for table `cc_attribute`
--

CREATE TABLE IF NOT EXISTS `cc_attribute` (
...
--
-- Dumping data for table `cc_attribute`
--
...
--
-- Table structure for table `cc_attribute_description`
--

CREATE TABLE IF NOT EXISTS `cc_attribute_description` (
  `attribute_id` int(11) NOT NULL,
...
--
-- Dumping data for table `cc_attribute_description`
--
...
--
-- Table structure for table `cc_attribute_group`
--

CREATE TABLE IF NOT EXISTS `cc_attribute_group` (
`attribute_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_attribute_group`
--
...
--
-- Table structure for table `cc_attribute_group_description`
--

CREATE TABLE IF NOT EXISTS `cc_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `cc_attribute_group_description`
--
...
--
-- Table structure for table `cc_banner`
--

CREATE TABLE IF NOT EXISTS `cc_banner` (
...
--
-- Dumping data for table `cc_banner`
--
...
--
-- Table structure for table `cc_banner_image`
--

CREATE TABLE IF NOT EXISTS `cc_banner_image` (
...
--
-- Dumping data for table `cc_banner_image`
--
...
--
-- Table structure for table `cc_banner_image_description`
--

CREATE TABLE IF NOT EXISTS `cc_banner_image_description` (
  `banner_image_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `banner_id` int(11) NOT NULL,
...
--
-- Dumping data for table `cc_banner_image_description`
--
...
(59, 'catalog/Penguins.jpg', 0, 0, 1, 0, 1, '2015-01-19 18:40:41', '2015-01-19 18:40:41');
...
--
-- Dumping data for table `cc_category_description`
--
...
(59, 1, 'design and development', '&lt;p&gt;&amp;nbsp;&lt;/p&gt;', 'design and development', '', ''),
(59, 2, '设计及媒体', '&lt;p&gt;【平面设计、3D动画、视频制作、包装设计、名片设计、配音、音效设计】&lt;/p&gt;', '设计 研发', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `cc_category_filter`
--

CREATE TABLE IF NOT EXISTS `cc_category_filter` (
  `category_id` int(11) NOT NULL,
...
--
-- Table structure for table `cc_category_path`
--

CREATE TABLE IF NOT EXISTS `cc_category_path` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `cc_category_path`
--
...
--
-- Table structure for table `cc_category_to_layout`
--

CREATE TABLE IF NOT EXISTS `cc_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `cc_category_to_layout`
--
...
--
-- Table structure for table `cc_category_to_store`
--

CREATE TABLE IF NOT EXISTS `cc_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_category_to_store`
--
...
CREATE TABLE IF NOT EXISTS `cc_coupon` (
...
CREATE TABLE IF NOT EXISTS `cc_coupon_category` (
  `coupon_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `cc_coupon_hisroty`
--

CREATE TABLE IF NOT EXISTS `cc_coupon_hisroty` (
...
CREATE TABLE IF NOT EXISTS `cc_coupon_product` (
...
--
-- Table structure for table `cc_currency`
--

CREATE TABLE IF NOT EXISTS `cc_currency` (
...
--
-- Dumping data for table `cc_currency`
--

INSERT INTO `cc_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.66210002, 1, '2015-01-19 23:55:32'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2015-01-19 23:59:06'),
(3, 'Euro', 'EUR', '', '€', '2', 0.86170000, 1, '2015-01-19 23:55:32'),
(4, '人民币', 'CNY', '￥', '2', '1', 1.00000000, 1, '2015-01-20 22:57:09');
...
--
-- Table structure for table `cc_customer_activity`
--

CREATE TABLE IF NOT EXISTS `cc_customer_activity` (
`activity_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `key` varchar(64) NOT NULL,
  `data` text NOT NULL,
...
--
-- Table structure for table `cc_customer_ban_ip`
--

CREATE TABLE IF NOT EXISTS `cc_customer_ban_ip` (
...
--
-- Table structure for table `cc_customer_group`
--

CREATE TABLE IF NOT EXISTS `cc_customer_group` (
`customer_group_id` int(11) NOT NULL,
...
--
-- Dumping data for table `cc_customer_group`
--
...
--
-- Table structure for table `cc_customer_group_description`
--

CREATE TABLE IF NOT EXISTS `cc_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `cc_customer_group_description`
--
...
--
-- Table structure for table `cc_customer_history`
--
...
--
-- Table structure for table `cc_customer_ip`
--

CREATE TABLE IF NOT EXISTS `cc_customer_ip` (
...
--
-- Table structure for table `cc_customer_online`
--

CREATE TABLE IF NOT EXISTS `cc_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
--
-- Table structure for table `cc_customer_transaction`
--

CREATE TABLE IF NOT EXISTS `cc_customer_transaction` (
...
--
-- Table structure for table `cc_custome_login`
--

CREATE TABLE IF NOT EXISTS `cc_custome_login` (
...
--
-- Table structure for table `cc_custome_rewards`
--

CREATE TABLE IF NOT EXISTS `cc_custome_rewards` (
...
--
-- Table structure for table `cc_custom_field`
--

CREATE TABLE IF NOT EXISTS `cc_custom_field` (
...
--
-- Table structure for table `cc_custom_field_customer_group`
--

CREATE TABLE IF NOT EXISTS `cc_custom_field_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- Table structure for table `cc_custom_field_description`
--

CREATE TABLE IF NOT EXISTS `cc_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `cc_custom_field_value`
--

CREATE TABLE IF NOT EXISTS `cc_custom_field_value` (
...
--
-- Table structure for table `cc_custom_field_value_description`
--

CREATE TABLE IF NOT EXISTS `cc_custom_field_value_description` (
  `custom_field_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
--
-- Table structure for table `cc_download_description`
--

CREATE TABLE IF NOT EXISTS `cc_download_description` (
  `download_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `cc_event`
--
...
--
-- Table structure for table `cc_extension`
--

CREATE TABLE IF NOT EXISTS `cc_extension` (
...
--
-- Dumping data for table `cc_extension`
--
...
--
-- Table structure for table `cc_filter`
--
...
--
-- Table structure for table `cc_filter_description`
--

CREATE TABLE IF NOT EXISTS `cc_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
...
--
-- Table structure for table `cc_filter_group`
--

CREATE TABLE IF NOT EXISTS `cc_filter_group` (
`filter_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `cc_filter_group_description`
--

CREATE TABLE IF NOT EXISTS `cc_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `cc_geo_zone` (
...
--
-- Table structure for table `cc_information`
--

CREATE TABLE IF NOT EXISTS `cc_information` (
...
--
-- Dumping data for table `cc_information`
--
...
--
-- Table structure for table `cc_information_description`
--

CREATE TABLE IF NOT EXISTS `cc_information_description` (
  `information_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(64) NOT NULL,
  `description` text NOT NULL,
...
--
-- Dumping data for table `cc_information_description`
--
...
--
-- Table structure for table `cc_information_to_layout`
--

CREATE TABLE IF NOT EXISTS `cc_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `cc_information_to_store`
--

CREATE TABLE IF NOT EXISTS `cc_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_information_to_store`
--
...
--
-- Table structure for table `cc_layout`
--

CREATE TABLE IF NOT EXISTS `cc_layout` (
`layout_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_layout`
--
...
--
-- Table structure for table `cc_layout_module`
--

CREATE TABLE IF NOT EXISTS `cc_layout_module` (
...
--
-- Dumping data for table `cc_layout_module`
--
...
--
-- Table structure for table `cc_layout_route`
--

CREATE TABLE IF NOT EXISTS `cc_layout_route` (
...
--
-- Dumping data for table `cc_layout_route`
--
...
--
-- Table structure for table `cc_length_class`
--

CREATE TABLE IF NOT EXISTS `cc_length_class` (
`length_class_id` int(11) NOT NULL,
  `value` decimal(15,8) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_length_class`
--
...
--
-- Table structure for table `cc_length_class_description`
--

CREATE TABLE IF NOT EXISTS `cc_length_class_description` (
`length_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
...
--
-- Dumping data for table `cc_length_class_description`
--
...
CREATE TABLE IF NOT EXISTS `cc_location` (
...
--
-- Table structure for table `cc_manufacturer`
--

CREATE TABLE IF NOT EXISTS `cc_manufacturer` (
...
--
-- Dumping data for table `cc_manufacturer`
--
...
--
-- Table structure for table `cc_manufacturer_to_store`
--

CREATE TABLE IF NOT EXISTS `cc_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_manufacturer_to_store`
--
...
--
-- Table structure for table `cc_marketing`
--

CREATE TABLE IF NOT EXISTS `cc_marketing` (
...
--
-- Table structure for table `cc_modification`
--

CREATE TABLE IF NOT EXISTS `cc_modification` (
...
--
-- Dumping data for table `cc_module`
--
...
CREATE TABLE IF NOT EXISTS `cc_option` (
...
--
-- Table structure for table `cc_option_description`
--

CREATE TABLE IF NOT EXISTS `cc_option_description` (
  `option_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `cc_option_description`
--
...
CREATE TABLE IF NOT EXISTS `cc_option_value` (
...
--
-- Table structure for table `cc_option_value_description`
--

CREATE TABLE IF NOT EXISTS `cc_option_value_description` (
  `option_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
--
-- Dumping data for table `cc_option_value_description`
--
...
--
-- Table structure for table `cc_order_custom_field`
--

CREATE TABLE IF NOT EXISTS `cc_order_custom_field` (
...
--
-- Table structure for table `cc_order_fraud`
--

CREATE TABLE IF NOT EXISTS `cc_order_fraud` (
  `order_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cc_order_option` (
...
--
-- Table structure for table `cc_order_product`
--
...
--
-- Table structure for table `cc_order_recurring`
--

CREATE TABLE IF NOT EXISTS `cc_order_recurring` (
...
--
-- Table structure for table `cc_order_recurring_transaction`
--

CREATE TABLE IF NOT EXISTS `cc_order_recurring_transaction` (
...
CREATE TABLE IF NOT EXISTS `cc_order_status` (
...
CREATE TABLE IF NOT EXISTS `cc_order_total` (
...
--
-- Table structure for table `cc_order_voucher`
--

CREATE TABLE IF NOT EXISTS `cc_order_voucher` (
...
CREATE TABLE IF NOT EXISTS `cc_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL
...
--
-- Table structure for table `cc_product_discount`
--

CREATE TABLE IF NOT EXISTS `cc_product_discount` (
...
--
-- Dumping data for table `cc_product_discount`
--
...
--
-- Table structure for table `cc_product_filter`
--

CREATE TABLE IF NOT EXISTS `cc_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `cc_product_image` (
...
CREATE TABLE IF NOT EXISTS `cc_product_option` (
`product_option_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `value` text NOT NULL,
...
--
-- Table structure for table `cc_product_option_value`
--

CREATE TABLE IF NOT EXISTS `cc_product_option_value` (
...
--
-- Dumping data for table `cc_product_option_value`
--
...
--
-- Table structure for table `cc_product_recurring`
--

CREATE TABLE IF NOT EXISTS `cc_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `cc_product_related` (
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `cc_product_reward`
--

CREATE TABLE IF NOT EXISTS `cc_product_reward` (
...
--
-- Dumping data for table `cc_product_reward`
--
...
CREATE TABLE IF NOT EXISTS `cc_product_special` (
...
--
-- Table structure for table `cc_product_to_download`
--

CREATE TABLE IF NOT EXISTS `cc_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `cc_product_to_layout`
--

CREATE TABLE IF NOT EXISTS `cc_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `cc_product_to_store`
--

CREATE TABLE IF NOT EXISTS `cc_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_product_to_store`
--
...
--
-- Table structure for table `cc_recurring`
--

CREATE TABLE IF NOT EXISTS `cc_recurring` (
`recurring_id` int(11) NOT NULL,
...
--
-- Table structure for table `cc_recurring_description`
--

CREATE TABLE IF NOT EXISTS `cc_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `cc_return`
--

CREATE TABLE IF NOT EXISTS `cc_return` (
...
--
-- Table structure for table `cc_return_action`
--

CREATE TABLE IF NOT EXISTS `cc_return_action` (
`return_action_id` int(11) NOT NULL,
...
--
-- Dumping data for table `cc_return_action`
--
...
--
-- Table structure for table `cc_return_history`
--

CREATE TABLE IF NOT EXISTS `cc_return_history` (
...
--
-- Table structure for table `cc_return_reason`
--

CREATE TABLE IF NOT EXISTS `cc_return_reason` (
`return_reason_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(128) NOT NULL
...
--
-- Dumping data for table `cc_return_reason`
--
...
--
-- Table structure for table `cc_return_status`
--

CREATE TABLE IF NOT EXISTS `cc_return_status` (
`return_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `cc_return_status`
--
...
--
-- Table structure for table `cc_review`
--

CREATE TABLE IF NOT EXISTS `cc_review` (
...
(346, 0, 'config', 'config_icon', 'catalog/Koala.jpg', 0),
...
(300, 0, 'config', 'config_zone_id', '708', 0),
(301, 0, 'config', 'config_language', 'cn', 0),
(302, 0, 'config', 'config_admin_language', 'cn', 0),
(303, 0, 'config', 'config_currency', 'CNY', 0),
(290, 0, 'config', 'config_fax', '', 0),
(291, 0, 'config', 'config_image', 'catalog/Koala.jpg', 0),
(292, 0, 'config', 'config_open', '', 0),
(293, 0, 'config', 'config_comment', '', 0),
(294, 0, 'config', 'config_meta_title', '聪聪，专业为您服务', 0),
...
(299, 0, 'config', 'config_country_id', '44', 0),
(289, 0, 'config', 'config_telephone', '123456789', 0),
(288, 0, 'config', 'config_email', 'kemengxiong@gmail.com', 0),
(287, 0, 'config', 'config_geocode', '086', 0),
(286, 0, 'config', 'config_address', '中华人民共和国上海市', 0),
(285, 0, 'config', 'config_owner', '丛丛小组', 0),
(284, 0, 'config', 'config_name', '丛丛', 0),
...
(388, 0, 'config', 'config_encryption', 'df6ee155cf9606e52181dcda42fe3748', 0),
...
--
-- Table structure for table `cc_stock_status`
--

CREATE TABLE IF NOT EXISTS `cc_stock_status` (
`stock_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `cc_stock_status`
--
...
--
-- Table structure for table `cc_store`
--
...
--
-- Table structure for table `cc_tax_class`
--

CREATE TABLE IF NOT EXISTS `cc_tax_class` (
`tax_class_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `description` varchar(255) NOT NULL,
  `date_added` datetime NOT NULL,
...
--
-- Dumping data for table `cc_tax_class`
--
...
--
-- Table structure for table `cc_tax_rate`
--

CREATE TABLE IF NOT EXISTS `cc_tax_rate` (
...
--
-- Dumping data for table `cc_tax_rate`
--
...
--
-- Table structure for table `cc_tax_rate_to_customer_group`
--

CREATE TABLE IF NOT EXISTS `cc_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_tax_rate_to_customer_group`
--
...
--
-- Table structure for table `cc_tax_rule`
--

CREATE TABLE IF NOT EXISTS `cc_tax_rule` (
...
--
-- Dumping data for table `cc_tax_rule`
--
...
--
-- Table structure for table `cc_upload`
--

CREATE TABLE IF NOT EXISTS `cc_upload` (
...
--
-- Table structure for table `cc_url_alias`
--

CREATE TABLE IF NOT EXISTS `cc_url_alias` (
...
--
-- Dumping data for table `cc_url_alias`
--
...
(1, 1, 'admin', '6b3ed85ffb35d3e967eb06493f0fd286f5e70d03', 'ca5c99018', 'John', 'Doe', 'kemengxiong@gmail.com', '', '', '127.0.0.1', 1, '2015-01-16 18:59:53');

-- --------------------------------------------------------

--
-- Table structure for table `cc_user_group`
--
...
--
-- Dumping data for table `cc_user_group`
--
...
--
-- Table structure for table `cc_voucher_history`
--

CREATE TABLE IF NOT EXISTS `cc_voucher_history` (
...
--
-- Table structure for table `cc_voucher_theme`
--

CREATE TABLE IF NOT EXISTS `cc_voucher_theme` (
`voucher_theme_id` int(11) NOT NULL,
  `image` varchar(255) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_voucher_theme`
--
...
--
-- Table structure for table `cc_voucher_theme_description`
--

CREATE TABLE IF NOT EXISTS `cc_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `cc_voucher_theme_description`
--
...
--
-- Table structure for table `cc_weight_class`
--

CREATE TABLE IF NOT EXISTS `cc_weight_class` (
`weight_class_id` int(11) NOT NULL,
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000'
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_weight_class`
--
...
--
-- Table structure for table `cc_weight_class_description`
--

CREATE TABLE IF NOT EXISTS `cc_weight_class_description` (
`weight_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `unit` varchar(4) NOT NULL
...
--
-- Dumping data for table `cc_weight_class_description`
--
...
CREATE TABLE IF NOT EXISTS `cc_zone` (
`zone_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
  `code` varchar(32) NOT NULL,
...
--
-- Table structure for table `cc_zone_to_geo_zone`
--

CREATE TABLE IF NOT EXISTS `cc_zone_to_geo_zone` (
...
--
-- Dumping data for table `cc_zone_to_geo_zone`
--
...
--
-- Indexes for table `cc_administrators`
--
ALTER TABLE `cc_administrators`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cc_coupon_hisroty`
--
ALTER TABLE `cc_coupon_hisroty`
...
--
-- Indexes for table `cc_custome_login`
--
ALTER TABLE `cc_custome_login`
 ADD PRIMARY KEY (`customer_login_id`), ADD KEY `email` (`email`), ADD KEY `ip` (`ip`);

--
-- Indexes for table `cc_custome_rewards`
--
ALTER TABLE `cc_custome_rewards`
...
--
-- AUTO_INCREMENT for table `cc_administrators`
--
ALTER TABLE `cc_administrators`
...
--
-- AUTO_INCREMENT for table `cc_coupon_hisroty`
--
ALTER TABLE `cc_coupon_hisroty`
...
--
-- AUTO_INCREMENT for table `cc_custome_login`
--
ALTER TABLE `cc_custome_login`
MODIFY `customer_login_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cc_custome_rewards`
--
ALTER TABLE `cc_custome_rewards`
